...
uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,  StdCtrls, ExtCtrls, shellapi, WinInet;
...
begin
     If (CheckUrl('www.infog2.com.br')) Then
        JumpTo('www.infog2.com.br')
     Else
        ShowMessage('Página não disponivel no momento!!!');
end;
...
function TfrmSobre.CheckUrl(url: string): boolean;
var
